...
async function setup() {
    ...
    gl.enable(gl.BLEND)
    let vs = await fetch('/assets/projects/graphics/psychedelic/vs.glsl').then((res) => res.text());
    let fs = await fetch('/assets/projects/graphics/psychedelic/fs.glsl').then((res) => res.text());
